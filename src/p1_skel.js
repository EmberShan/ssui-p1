...
class FittsTestUI extends UIClass {
    ...
    buildUIObjects() {
        ...
        this.childObjects.push((this._theBackground = new BackgroundDisplay(this.canvas.width, this.canvas.height, this)));
...
class BackgroundDisplay extends ScreenObject {
    ...
    draw(ctx) {
        ...
        ctx.fillText(this._msg2, xpos, ypos + fontHeight, this._parentUI.canvas.width);
        ctx.fillText(this._msg3, xpos, ypos + 2 * fontHeight, this._parentUI.canvas.width);
    }
    // . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . .
